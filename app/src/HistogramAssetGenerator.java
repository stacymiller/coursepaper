 ...
 */
public class HistogramAssetGenerator extends AssetGenerator {
     ...
     * @return
     */
    public static ImitatedAsset generateAssetTreeByHistogram(int width, int branch, int steps, int sectors, double initialPrice){
        timedelta = 1. / steps;
